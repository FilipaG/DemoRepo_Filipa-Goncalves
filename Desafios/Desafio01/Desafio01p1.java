...
public class Desafio01p1 {
/*recebe um número inteiro positivo do input da consola e que retorna 10 números inteiros 
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= originalValue; i++)
		{
			...
			if (i % 2 == 0){  //só imprime caso para o caso de i ser par
				...
				for (int j = 10; j > 0; j--){   //gerar os 10 números inferiores a i
					int num = i - j;      
